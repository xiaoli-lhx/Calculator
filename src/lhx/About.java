...
public class About extends JDialog {
    ...
    public About() {
        ...
        JTextArea J1 = new JTextArea("版本：2024_05_07_1.0.0\n开发者：lhx Forked from nullxjx/Calculator\n开发语言：Java\n"
                + "Email: hanxuli1211@gmail.com");
        J1.setFocusable(false);
        J1.setFont(f2);
        J1.setEditable(false);
        J1.setOpaque(false);//背景透明
        shadePanel.add(J1);
        J1.setBounds(10, 10, 450, 180);
        ...
        final JLabel MyGithub = new JLabel("https://github.com/xiaoli-lhx");
        MyGithub.setFont(f2);
        MyGithub.setBackground(Color.white);
        MyGithub.addMouseListener(new InternetMonitor());
        JLabel MyCnBlog_Label = new JLabel("bilibili:");
        MyCnBlog_Label.setFont(f2);
        final JLabel MyCnBlog = new JLabel("https://space.bilibili.com/1494969296");
        MyCnBlog.setFont(f2);
